                               ...
                               <div class="table-responsive">
                                ...
                                <table class="table" id="my_table">
                                    ...
                                    <tbody>
                                        ...
                                        <td class="ignore_me"><a href="welfare_manager_payment.php?i=<?php echo $each_member['member_id'] ?>" class="btn btn-primary" title="Make Payment"><i class="fa fa-plus"></i></a></td> 
                                           </tr>
                                       <?php }
