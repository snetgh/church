                ...
                <div id="cm-menu-items-wrapper">
                    <div id="cm-menu-scroller">
                        <ul class="cm-menu-items">
                            ...
                            <li class="active"><a href="birthdays.php" class="sf-heart">Birthdays</a></li>
                   ...
                   <div class="row cm-fix-height">
                    <div class="col-lg-12 col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">Birthdays This Week </div>
                               ...
                               <div class="table-responsive">
                                ...
                                <table class="table" id="my_table">
                                    ...
                                    <tbody>
                                        ...
                                        $run_get_query = mysqli_query($connection,"SELECT * FROM members_table WHERE `member_dob` BETWEEN '$first_day_this_week' AND '$last_day_this_week' ");
                                        ...
                                        <td><?php echo date("Y-M-d",strtotime($each_member["member_dob"])); ?></td> 
