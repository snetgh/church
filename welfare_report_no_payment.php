                ...
                <div id="cm-menu-items-wrapper">
                    <div id="cm-menu-scroller">
                        <ul class="cm-menu-items">
                            ...
                            <li class="active"><a href="welfare_report_no_payment.php" class="sf-file-pdf">Report Welfare Non-Paid</a></li>
        ...
        <div id="global">
                ...
                if(isset($_POST['btn_submit'])){
                    ...
                    <div class="col-lg-12  col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">Report On Non Payment From: &nbsp; <?php  switch ($get_from) {
        case '1':
            echo "January";
            break;
