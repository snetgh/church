                ...
                <div id="cm-menu-items-wrapper">
                    <div id="cm-menu-scroller">
                        <ul class="cm-menu-items">
                            ...
                            <li class="active"><a href="welfare_manager_report_payment.php" class="sf-file-word">Report Welfare Paid</a></li>
                ...
                <div class="row cm-fix-height">
                    <div class="col-lg-6 col-lg-offset-3 col-md-6 col-md-offset-3">
                        <div class="panel panel-default">
                            <div class="panel-heading">Welfare - Paid Members</div>
                               ...
                               <div class="table-responsive">
                                ...
                                <table class="table" id="my_table">
                                    ...
                                    <tbody>
                                        ...
                                        $run_get_query = mysqli_query($connection,"SELECT * FROM welfare_accounts JOIN `members_table` on `members_table`.`member_id` = `welfare_accounts`.`welfare_user_id` WHERE `welfare_month` BETWEEN '$get_from' AND '$get_to' AND `welfare_year` = '$get_year'");
