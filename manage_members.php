                   ...
                   <div class="row cm-fix-height">
                    <div class="col-lg-12 col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">Manage Members </div>
                               ...
                               <div class="table-responsive">         
                                ...
                                <table class="table" id="my_table">
                                    ...
                                    <tbody>
                                        ...
                                        <td><a href="edit_delete.php?i=<?php echo $each_member['member_id']   ?> &s=u" class="btn btn-primary" title="Edit Person"><i class="fa fa-edit"></i></a><a href="edit_delete.php?i=<?php echo $each_member['member_id']   ?> &s=d" class="btn btn-danger" title="Delete Person"><i class="fa fa-trash"></i></a></td> 
